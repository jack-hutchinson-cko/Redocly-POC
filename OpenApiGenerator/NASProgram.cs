...
namespace openApiGenerator
{
    class NASProgram
    {
        ...
        static string _specDirectory = "developer-portal/nas-spec";
        static string _yamlOutputFile = "openapi/nas-swagger.yaml";
        static string _jsonOutputFile = "openapi/nas-swagger.json";
