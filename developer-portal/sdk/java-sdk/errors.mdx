...
<Information type="information">
	It's important to understand that Declines, or 3D Secure responses do not throw an exception, since the status code
	associated with them are in the 20* range. In the <Link to="/developer-portal/sdk/payments">Payments</Link> section
	you will see some examples of best practices when it comes to handling responses.
</Information>
